...
All the available options for the benchmarks can be read out with: ```./<benchmark_name> --help```. 
...
Under the LGPLv3, you have the right to replace perf-cpp with your own modified version and rebuild this program against it. 
To do so:
